...
# Read the template from integrated-epc-services/body.html
template_path = r"c:\Users\Administrator\.gemini\antigravity\scratch\18 - Gasco Website\content\integrated-epc-services\body.html"
...
services_data = {
    "engineering-consultancy": {
        ...
        "showcase_img": "/wp-content/uploads/2024/09/banner-1.jpg",
        ...
        "proj1": ("/wp-content/uploads/2024/09/portfolio-1.jpg", "MOL Pakistan", "Central Compression FEED &amp; Engineering", "Front-end engineering design and 3D piping layouts for Makori Central Compression Facility."),
        "proj2": ("/wp-content/uploads/2024/09/portfolio-2.jpg", "PPL (Pakistan Petroleum)", "Amine Sweetening Unit Detailed Design", "Detailed mechanical engineering and stress analysis for high-pressure gas sweetening absorber column."),
        "proj3": ("/wp-content/uploads/2024/09/blog-1.jpg", "Mari Petroleum (MPCL)", "Gas Booster Station Piping &amp; E&amp;I Design", "Comprehensive electrical, instrumentation, and piping stress analysis for field booster compressor skids.")
    },
    "pipeline-construction": {
        ...
        "showcase_img": "/wp-content/uploads/2024/09/service-3.jpg",
        ...
        "proj1": ("/wp-content/uploads/2024/09/portfolio-5.jpg", "PGNIG", "Rizq-2, Rehman-4 &amp; Rehman-5 Lines", "High-pressure gas gathering pipelines connecting multiple wellheads to the central processing facility."),
        "proj2": ("/wp-content/uploads/2024/09/portfolio-6.jpg", "MOL Pakistan", "Makori High-Pressure Gas Loopline", "Fast-track cross-country steel pipeline installation including HDD river crossing and valve stations."),
        "proj3": ("/wp-content/uploads/2024/09/portfolio-7.jpg", "Mari Petroleum (MPCL)", "Field Booster Interconnecting Network", "Large-diameter gathering network tie-in connecting booster compressors to the main transmission line.")
    },
    "rental-compression-production": {
        ...
        "showcase_img": "/wp-content/uploads/2024/09/service-4.jpg",
        ...
        "proj1": ("/wp-content/uploads/2024/09/portfolio-1.jpg", "Engro Fertilizers", "3 x 7,950 HP Gas Compression Package", "High-capacity rental compression station delivering 150 MMSCFD gas boosting for fertilizer feed."),
        "proj2": ("/wp-content/uploads/2024/09/portfolio-2.jpg", "Eni Pakistan", "Bhit Wellhead Booster Compression", "Wellhead pressure boosting compression package extending economic field production."),
        "proj3": ("/wp-content/uploads/2024/09/portfolio-3.jpg", "OMV Pakistan", "Miano 18 Low-Pressure Boosting Skid", "Skid-mounted gas compressor package boosting low-pressure well gas into main gathering header.")
    },
    "outsource-warehousing": {
        ...
        "showcase_img": "/wp-content/uploads/2024/10/about-6.jpg",
        ...
        "proj1": ("/wp-content/uploads/2024/09/portfolio-4.jpg", "Multinational E&P", "Central Oilfield Materials Storage Hub", "Turnkey management of major multinational E&P spare parts inventory and drilling consumables."),
        "proj2": ("/wp-content/uploads/2024/09/portfolio-5.jpg", "GASCO Operations", "Heavy Machinery &amp; Valve Preservation Yard", "Specialized preservation yard for high-pressure control valves, turbines, and compressor spares."),
        "proj3": ("/wp-content/uploads/2024/09/portfolio-6.jpg", "Pipeline Division", "Line Pipe &amp; Heavy Fitting Depot", "Dedicated outdoor pipe storage depot with 24/7 crane handling and protective coating maintenance.")
    },
    "operations-maintenance": {
        ...
        "showcase_img": "/wp-content/uploads/2024/10/subscribe.jpg",
        ...
        "proj1": ("/wp-content/uploads/2024/09/portfolio-8.jpg", "PPL (Pakistan Petroleum)", "HRL Compressor Revamp &amp; Turnaround", "Major overhaul and annual turnaround execution for Kandhkot gas field compressor package."),
        "proj2": ("/wp-content/uploads/2024/09/skill.jpg", "MOL Pakistan", "Makori Gas Plant Long-Term O&M", "Long-term facility operations and routine maintenance contract maintaining 98%+ plant availability."),
        "proj3": ("/wp-content/uploads/2024/09/about-5.jpg", "Mari Petroleum (MPCL)", "Field Booster Station Maintenance", "24/7 operation and predictive maintenance of gas pressure boosting compressor stations.")
    }
}
...
def generate_page(slug, d):
    ...
    # 1. Hero replacements
    html = html.replace("Leading Oil &amp; Gas EPCC Contractor", d["hero_badge"])
    html = html.replace("Integrated EPCC &amp;", d["hero_h2_line1"])
    html = html.replace("Turnkey Solutions", d["hero_h2_line2"])

    # 2. Showcase replacements
    html = html.replace("TURNKEY EPCC CAPABILITY", d["showcase_badge"])
    html = html.replace("Pioneering Full-Scope EPC &amp; EPCC Infrastructure Delivery", d["showcase_h2"])
    html = html.replace("GASCO provides end-to-end Integrated EPC (Engineering, Procurement, Fabrication, and Construction) solutions designed to deliver seamless execution for complex oil, gas, and energy processing facilities across Pakistan.", d["showcase_p1"])
    ...
    html = html.replace(old_stmt, d["statement_text"])

    html = html.replace("<h2>35M+</h2>\n          <p>Safe Man-Hours</p>", f"<h2>{d['stat1_val']}</h2>\n          <p>{d['stat1_lbl']}</p>")
    html = html.replace("<h2>50+</h2>\n          <p>Years of Excellence</p>", f"<h2>{d['stat2_val']}</h2>\n          <p>{d['stat2_lbl']}</p>")
    html = html.replace("<h2>200+</h2>\n          <p>Successful Projects</p>", f"<h2>{d['stat3_val']}</h2>\n          <p>{d['stat3_lbl']}</p>")
    html = html.replace("<h2>100%</h2>\n          <p>Safety &amp; Compliance</p>", f"<h2>{d['stat4_val']}</h2>\n          <p>{d['stat4_lbl']}</p>")

    # 4. Carousel Methodology replacements
    html = html.replace("End-to-End Project Execution Methodology", d["carousel_head"])
    html = html.replace("Our integrated approach eliminates interface risks between engineering design, global procurement, modular shop fabrication, and field commissioning.", d["carousel_desc"])

    # Replace the 6 cards in both set 1 and duplicate set 2
    # Define old card texts in master template
    old_cards = [
    ...
    for i in range(6):
        old_h4, old_p = old_cards[i]
        new_num, new_h4, new_p = d["cards"][i]
        html = html.replace(f"<h4>{old_h4}</h4>\n            <p>{old_p}</p>", f"<h4>{new_h4}</h4>\n            <p>{new_p}</p>")
        html = html.replace(f"<h4>{old_h4}</h4>\n            <p>{old_p}</p>", f"<h4>{new_h4}</h4>\n            <p>{new_p}</p>")

    # 5. Featured Projects replacements
    ...
    target_file = f"c:\\Users\\Administrator\\.gemini\\antigravity\\scratch\\18 - Gasco Website\\content\\{slug}\\body.html"
    with open(target_file, "w", encoding="utf-8") as out:
        out.write(html)
    print(f"Updated {slug} successfully.")

for slug, data in services_data.items():
    generate_page(slug, data)
print("All 5 service pages generated!")
