...
def generate_service_body(slug, config):
    ...
    html = html.replace("/hse/dhok_sultan_hazop_audit%201.jpg", config["showcase_img"])
    ...
    # Card 1
    html = html.replace('<img src="/hse/compression_occupational_hygiene%201.jpg" alt="Makori Gas Facility">', f'<img src="{config["proj1"][0]}" alt="{config["proj1"][2]}">')
    ...
    # Card 2
    html = html.replace('<img src="/hse/asme_skid_hazop_review%201.jpg" alt="Adhi Gas Sweetening Unit">', f'<img src="{config["proj2"][0]}" alt="{config["proj2"][2]}">')
    ...
    # Card 3
    html = html.replace('<img src="/hse/dhok_sultan_hazop_audit%201.jpg" alt="Mari Gas Pressure Boosting Station">', f'<img src="{config["proj3"][0]}" alt="{config["proj3"][2]}">')
...
configs = {
    "engineering-consultancy": {
        ...
        "showcase_img": "/hse/asme_skid_hazop_review%201.jpg",
        ...
        "proj1": ("/hse/compression_occupational_hygiene%201.jpg", "MOL Pakistan", "Central Compression FEED &amp; Engineering", "Front-end engineering design and 3D piping layouts for Makori Central Compression Facility."),
        "proj2": ("/hse/asme_skid_hazop_review%201.jpg", "PPL (Pakistan Petroleum)", "Amine Sweetening Unit Detailed Design", "Detailed mechanical engineering and stress analysis for high-pressure gas sweetening absorber column."),
        "proj3": ("/hse/dhok_sultan_hazop_audit%201.jpg", "Mari Petroleum (MPCL)", "Gas Booster Station Piping &amp; E&amp;I Design", "Comprehensive electrical, instrumentation, and piping stress analysis for field booster compressor skids.")
    },
    "pipeline-construction": {
        ...
        "showcase_img": "/hse/pipeline_integrity_audit.jpg",
        ...
        "proj1": ("/hse/water_eia_environmental_study%201.jpg", "PGNIG", "Rizq-2, Rehman-4 &amp; Rehman-5 Lines", "High-pressure gas gathering pipelines connecting multiple wellheads to the central processing facility."),
        "proj2": ("/hse/pipeline_integrity_audit.jpg", "MOL Pakistan", "Makori High-Pressure Gas Loopline", "Fast-track cross-country steel pipeline installation including HDD river crossing and valve stations."),
        "proj3": ("/hse/pipeline_integrity_audit.jpg", "Mari Petroleum (MPCL)", "Field Booster Interconnecting Network", "Large-diameter gathering network tie-in connecting booster compressors to the main transmission line.")
    },
    "rental-compression-production": {
        ...
        "showcase_img": "/hse/gas_processing_fera_simulation%202.jpg",
        ...
        "proj1": ("/hse/compression_occupational_hygiene%201.jpg", "Engro Fertilizers", "3 x 7,950 HP Gas Compression Package", "High-capacity rental compression station delivering 150 MMSCFD gas boosting for fertilizer feed."),
        "proj2": ("/hse/asme_skid_hazop_review%201.jpg", "Eni Pakistan", "Bhit Wellhead Booster Compression", "Wellhead pressure boosting compression package extending economic field production."),
        "proj3": ("/hse/gas_processing_fera_simulation%202.jpg", "OMV Pakistan", "Miano 18 Low-Pressure Boosting Skid", "Skid-mounted gas compressor package boosting low-pressure well gas into main gathering header.")
    },
    "outsource-warehousing": {
        ...
        "showcase_img": "/hse/compression_iso_audit.jpg",
        ...
        "proj1": ("/hse/compression_iso_audit.jpg", "Multinational E&P", "Central Oilfield Materials Storage Hub", "Turnkey management of major multinational E&P spare parts inventory and drilling consumables."),
        "proj2": ("/hse/Construction%20site%20concrete%20pouring%201.png", "GASCO Operations", "Heavy Machinery &amp; Valve Preservation Yard", "Specialized preservation yard for high-pressure control valves, turbines, and compressor spares."),
        "proj3": ("/hse/Construction%20site%20concrete%20pouring%202.png", "Pipeline Division", "Line Pipe &amp; Heavy Fitting Depot", "Dedicated outdoor pipe storage depot with 24/7 crane handling and protective coating maintenance.")
    },
    "operations-maintenance": {
        ...
        "showcase_img": "/hse/dhok_sultan_hazop_audit%201.jpg",
        ...
        "proj1": ("/hse/dhok_sultan_hazop_audit%201.jpg", "PPL (Pakistan Petroleum)", "HRL Compressor Revamp &amp; Turnaround", "Major overhaul and annual turnaround execution for Kandhkot gas field compressor package."),
        "proj2": ("/hse/compression_occupational_hygiene%201.jpg", "MOL Pakistan", "Makori Gas Plant Long-Term O&M", "Long-term facility operations and routine maintenance contract maintaining 98%+ plant availability."),
        "proj3": ("/hse/asme_skid_hazop_review%202.jpg", "Mari Petroleum (MPCL)", "Field Booster Station Maintenance", "24/7 operation and predictive maintenance of gas pressure boosting compressor stations.")
    }
}
